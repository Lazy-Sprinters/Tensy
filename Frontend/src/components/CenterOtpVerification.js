...
export class CenterOtpVerification extends Component {
  ...
  sendOtp = (x) => {
    ...
    console.log(data);
    Axios.post("http://localhost:8080/vendor/newotps", data)
      .then((res) => {})
      .catch((err) => {
  ...
  handleVerification = (res) => {
    ...
    setTimeout(() => this.setState({ indicate: true }), 3000);
  };
  ...
  verifyOtp = (otp1, otp2, centerInfo) => {
    ...
    Axios.post("http://localhost:8080/vendor/signup2", data)
      .then((res) => {
    ...
    return (
      <div style={{ backgroundColor: "#fcf8f7" }}>
        ...
        <div className="err-msg">
          <h2>
            Check your registered email id and phone number for the One-Time
            Passwords. Verification is needed for accessing features of the
            site. You cannot log in before verifying your account. If you skip
            it, your saved information will be deleted, and you have to register
            again.
          </h2>
        </div>
        <br />
        ...
        <div className="otp1btn">
          ...
          >
            {parseInt(Object.values({ counter })) == 0
              ? "Resend Otp"
              : "Resend Otp ( " +
                parseInt(Object.values({ counter })) +
                " sec )"}
          </Button>
        </div>
        ...
        {isOtpFaulty && (
          <div>
            ...
            <div className="err-msg">
              ...
              >
                *There is an error in sending the OTP to the desired email or
                phone number.You must have reloaed the page ,please login to
                verify your account.
              </div>
            </div>
            <br />
