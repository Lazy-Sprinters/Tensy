...
export class CenterRegisterForm extends Component {
          ...
          <tbody>
            {PseudoFacilities.map((value, i) => (
              <tr>
                ...
                <td>
                  <DeleteOutlinedIcon
                    onClick={() => this.handleDelete(i, PseudoFacilities)}
                  />
                </td>
              </tr>
            ))}
  ...
  register = (data) => {
    ...
    // this.handleRegister();
    console.log(data);
    Axios.post("http://localhost:8080/vendor/signup1", data)
      .then((res) => {
        console.log(res);
    ...
    return (
      <div style={{ marginBottom: "-2vh" }}>
        <Select
          ...
          style={{ margin: "20px", minWidth: "120px" }}
          variant="outlined"
        >
                    ...
                    <div className="btn2">
                      {!isLoading && !isLoaded && (
                        <Button
                          ...
                          variant="contained"
                          onClick={() =>
                            this.handleAddAnother(FacilityName, Services)
                          }
                        >
                          Add
                        </Button>
