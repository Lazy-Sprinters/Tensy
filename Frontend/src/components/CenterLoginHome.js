...
export class CenterLoginHome extends Component {
  ...
  fn1 = (Vendor_id, Rfp_id, Manufacturer_id) => {
    ...
    console.log(data);
    Axios.post("http://localhost:8080/vendor/firstacceptforconsideration", data)
      .then((res) => {
        console.log(res);
  ...
  fn2 = (
    ...
    console.log(x);
    Axios.post("http://localhost:8080/vendor/firstsubmitnego", x)
      .then((res) => {
        console.log(res);
        // this.handleSearch(res);
        window.location.reload();
  ...
  handleSearch = (x, y) => {
    console.log(x);
    Axios.post("http://localhost:8080/vendor/allvalidrfps", x)
      .then((res) => {
        console.log(res);
  ...
  authenticate = (x) => {
    ...
    // Axios.post("http://localhost:8080/helper/check1",centerInfo)
    // .then((res) => {
    //   ;
    //   })
    //   .catch((err) => {
    ...
    //   });
    Axios.post("http://localhost:8080/vendor/list", data)
      .then((res) => {
        ...
        <div className="cbody">
          {ModalShow1 && (
            <TnCModal
              ...
              onAgree={() =>
                this.fn1(
                  this.props.centerInfo.data._id,
                  x.Rfp_id,
                  x.Manufacturer_id
                )
              }
          ...
          {Nores ? (
            <h3 style={{ margin: "20vw 0vw", textAlign: "center" }}>
              No RFPs available at the moment
            </h3>
          ) : (
            <>
              {auth1 && (
                <div style={{ margin: "11vw 27vw" }}>
                  <h3 style={{ margin: "12vw 0vw", textAlign: "center" }}>
                    Search and Find The RFPs of your products
                  </h3>
                  <div className="row">
                    <label
                      style={{
                    ...
                    <Button
                      ...
                      onClick={() =>
                        this.handleSearch(
                          {
                            Product,
                            Vendor_id: this.props.centerInfo.data._id,
                          },
                          this.props.centerInfo
                        )
                      }
                    >
                      Search
