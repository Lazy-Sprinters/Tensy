...
function TnCModal(props) {
  ...
  const [Total_Quantity_required, setTotal_Quantity_required] =
    React.useState("");
  ...
  const handleRfp = (x) => {
    console.log(x);
    Axios.post("http://localhost:8080/rfp/new", x)
      .then((res) => {
    ...
    >
          ...
          <div className="row">
            <div className="col">
              {props.name1.length > 0 ? (
                ...
                <div>
                  <label style={{ marginTop: "1vh", marginLeft: "3vw" }}>
                    Product
                  </label>
      ...
      <Modal.Footer>
        ...
        <Button
          ...
          onClick={() =>
            handleRfp({
              Manufacturer: props.a,
              Manufacturer_id: props.b,
              Status: props.c,
              Product_Name,
              Unit,
              Cost_per_Unit,
