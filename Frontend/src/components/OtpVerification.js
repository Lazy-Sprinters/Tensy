...
export class OtpVerification extends Component {
  ...
  sendOtp = (x) => {
    ...
    Axios.post("http://localhost:8080/manufacturer/newotps", data)
      .then((res) => {})
      .catch((err) => {
  ...
  verifyOtp = (otp1, otp2, userInfo) => {
    ...
    Axios.post("http://localhost:8080/manufacturer/signup2", data)
      .then((res) => {
      ...
      <div style={{ backgroundColor: "#fcf8f7" }}>
        ...
        <div className="err-msg">
          <h4>
            ...
            Passwords. Verification is needed for booking appointments for the
            site. You can either verify it now or skip to perform the
            verification later.
          </h4>
        </div>
        <br />
            ...
            <div className="err-msg">
              ...
              >
                *There is an error in sending the OTP to the desired email or
                phone number.You must have reload the page ,please login to
                verify your account.
              </div>
            </div>
            <br />
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onChangeCheck: (check) =>
      dispatch({ type: actionTypes.CHANGE_STATE, check: check }),
  };
};
