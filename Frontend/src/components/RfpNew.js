...
export class RfpNew extends React.Component {
  ...
  getExpired = (x) => {
    ...
    Axios.post("http://localhost:8080/agreements/upd", data)
      .then((res) => {
        console.log(res);
  ...
  render() {
    ...
    const { initial, product, initial1, drpdwn, name, ModalShow } = this.state;
          ...
          <div className="row">
            ...
            <div style={{ marginTop: "40vh", marginLeft: "18vw" }}>
              <Button
                ...
                style={{
                  boxShadow: "0px 0px 14px 0.3px bisque",
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onChangebookInfo: (bookInfo) =>
      dispatch({ type: actionTypes.CHANGE_BOOKINFO, bookInfo: bookInfo }),
